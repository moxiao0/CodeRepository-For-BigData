object HopWindowExample {
  def main(args: Array[String]): Unit = {
    ...
    //使用Flink SQL进行滑动窗口聚合查询
    val result = tableEnv.sqlQuery(
      """
        |SELECT
        |  HOP_START(eventTime, INTERVAL '5' MINUTE, INTERVAL '15' MINUTE) as windowStart,
        |  HOP_END(eventTime, INTERVAL '5' MINUTE, INTERVAL '15' MINUTE) as windowEnd,
        |  userID,
        |  SUM(clicks) as totalClicks
        |FROM UserClicks
        |GROUP BY HOP(eventTime, INTERVAL '5' MINUTE, INTERVAL '15' MINUTE), userID
      """.stripMargin)
    ...
    //启动流处理程序
    env.execute("Hop Window Example")
  }
}
